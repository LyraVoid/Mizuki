...
export const siteConfig: SiteConfig = {
	title: "御剑乘风の小破站",
	subtitle: "",
	siteURL: "https://mizuki.666411.xyz/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "assets/home/1280x1280.png",
	},

	bangumi: {
		userId: "yjcf", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	favicon: [
		// 留空以使用默认 favicon
		{
		  src: '/favicon/320x320.jpeg',    // 图标文件路径
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/3200x3200.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "御剑乘风",
	bio: "还有一件事！",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		...
		lang: SITE_LANG, // 设置 Twikoo 评论系统语言
	},
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting-api.666411.xyz/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "7281969620", // 歌单ID
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_KLRLrceCy9smDQ0YRTSuKJFlsgGksbf6", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="0d4fcacc-07de-4121-8357-6c66014374cf"></script>
